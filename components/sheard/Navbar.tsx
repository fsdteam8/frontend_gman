...
//             <p className="mb-4">
//               I want to thank everyone who has sign up and is using our
//               platform. Tablefresh is free to use, building community and
//               connecting everyone to fresh nutritious food, Any and all
//               donations are greatly appreciated , ensuring the future of the
//               best fresh food global platform
//             </p>
//             <p className=" text-[#595959] mt-7 ">Thank You <br /> from the <br /> Tablefresh Team</p>
//           </div>
//           <div className="mt-6 flex flex-col items-center gap-4">
//             <Link
//               href="#"
//               className="text-md font-semibold text-[#039B06] underline hover:no-underline"
//             >
//               Set Your Payment
//             </Link>
//             <Input
...
//             />
//             <Button onClick={handleDonation} className="w-full rounded-md bg-[#039B06] py-3 text-lg font-semibold text-white hover:bg-[#028a05]">
//               Donate Now
//             </Button>
//           </div>
//         </DialogContent>
...
export function Navbar() {
  ...
  const { data: profile, error } = useQuery<UserProfile, Error>({
    queryKey: ["userProfile"],
    queryFn: () => fetchUserProfile(session?.accessToken || ""),
    enabled: isLoggedIn && !!session?.accessToken,
  })
  ...
  const handleDonation = () => {
    ...
    setAmount(donationAmount) // Update state with the parsed number
    ...
    <>
        ...
        <DialogContent className="w-[90%] max-w-md rounded-xl p-6 sm:p-8">
          <DialogHeader className="relative flex flex-col items-center text-center">
            <Image
              ...
              priority
            />
            <DialogTitle className="text-2xl font-semibold text-[#272727]">Make a Secure Donation</DialogTitle>
          </DialogHeader>
          <div className="mt-4 text-justify text-[18px] text-[#595959] leading-[150%]">
            <p className="mb-4">
              I want to thank everyone who has signed up and is using our platform. Tablefresh is free to use, building
      ...
      <Dialog open={isAmitModalOpen} onOpenChange={setIsAmitModalOpen}>
        <DialogContent className="w-[90%] rounded-xl p-6 sm:p-8 text-center">
          {profile?.data?._id && (
            <CheckoutFormWrapper userId={profile.data._id} amount={amount as number} type="donation" />
          )}
        </DialogContent>
      </Dialog>
    </>
