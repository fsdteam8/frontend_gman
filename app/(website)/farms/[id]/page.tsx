...
import { MapPin, Star, MessageCircle, Clock6 } from "lucide-react";
...
export default function FarmPage() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen container mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8">
        <div className="animate-pulse">
          {/* Skeleton for Page Header */}
          <div className="h-40 xs:h-48 sm:h-56 md:h-64 lg:h-72 bg-gray-200 rounded-lg mb-6 sm:mb-8"></div>
          {/* Skeleton for Farm Header */}
          <div className="flex flex-col gap-4 mb-8">
            <div className="flex items-start gap-4">
              <div className="w-14 h-14 xs:w-16 xs:h-16 sm:w-20 sm:h-20 rounded-full bg-gray-200"></div>
            ...
            <div className="w-full h-40 xs:h-48 sm:h-56 rounded-lg bg-gray-200"></div>
          </div>
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8 lg:pt-12">
        {/* Farm Header */}
        <div className="mb-6 sm:mb-8 lg:mb-10 flex flex-col lg:flex-row gap-6 lg:gap-8">
          <div className="flex-1">
              ...
              <div className="flex-1 min-w-0">
                ...
                {farm.isOrganic && (
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs xs:text-sm text-[#039B06] font-normal">
            ...
            <div className="mt-4 sm:mt-6">
              <p className="text-xs xs:text-sm sm:text-base text-[#4B5563] font-normal mb-3 sm:mb-4">
                {farm.description}
              </p>
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                <div className="flex  items-center gap-2">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="font-semibold text-[#000000] text-base xs:text-sm">
              ...
              <div className="mt-3">
                  ...
                  disabled={loading}
                  className="bg-[#039B06] hover:bg-[#039B06]/80 text-white rounded-[4px] w-full sm:w-auto text-xs xs:text-sm sm:text-base px-3 sm:px-4 py-2"
                >
                  <MessageCircle className="w-3 h-3 xs:w-4 xs:h-4 mr-2" />
                  {loading ? "Starting Message..." : "Message Farmer"}
                </Button>
              </div>
            </div>
          </div>
          <div className="w-full lg:w-[600px] xl:w-[700px] h-48 xs:h-56 sm:h-64 lg:h-80 border border-gray-200 rounded-lg overflow-hidden">
            {farm.latitude && farm.longitude ? (
              ...
              <div className="flex items-center justify-center h-full text-gray-500 text-xs xs:text-sm sm:text-base">
        ...
        <div className="pb-6 sm:pb-8 lg:pb-12">
          <h2 className="text-base xs:text-lg sm:text-xl font-bold text-[#272727] mb-4 sm:mb-6 lg:mb-8">
            Farm Products
          </h2>

          {products.length === 0 ? (
            <div className="text-center text-sm xs:text-base sm:text-lg text-[#4B5563] font-medium">
                ...
                >
                  <div className="group cursor-pointer relative overflow-hidden">
                    <div className="relative">
                      ...
                      >
                        <Heart
                          className={`w-3 h-3 xs:w-4 xs:h-4 transition-colors ${
                            favorites.includes(product._id)
