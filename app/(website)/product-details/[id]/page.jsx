...
export default function Page() {
  ...
  if (!product) return <div className="text-center py-10">No product data available</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 mb-8">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm sm:text-base text-[#323232] font-normal underline mb-2">{product.farm.name}</p>
              ...
              <div className="flex flex-wrap items-center gap-4 mb-4">
                ...
                <div className="flex items-center gap-1">
                  <Star className="h-4 w-4 fill-[#FFD700] text-[#FACC15]" />
                  <span className="text-xs sm:text-sm font-medium">{product.review.length > 0 ? product.review[0]?.rating : "No reviews"}</span>
                  <span className="text-xs sm:text-sm text-[#707070]">({product.review.length})</span>
                </div>
              </div>

              <div className="mb-6">
                <div className="text-lg sm:text-xl font-semibold text-[#111827] mt-6 mb-1">${product.price} per box</div>
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-7">
                <div>
                  <label className="text-xs sm:text-sm font-medium text-gray-700 mb-2 block">QTY</label>
                  <div className="flex items-center border-[1px] border-[#595959] rounded-md">
                    <Button variant="ghost" size="sm" onClick={() => updateQuantity(-1)} className="h-8 sm:h-10 w-8 sm:w-10 p-0">
                      <Minus className="h-4 w-4" />
                    </Button>
                    <span className="px-3 sm:px-4 py-1 sm:py-2 min-w-[40px] sm:min-w-[60px] text-center text-sm sm:text-base">{quantity}</span>
                    <Button variant="ghost" size="sm" onClick={() => updateQuantity(1)} className="h-8 sm:h-10 w-8 sm:w-10 p-0">
                      <Plus className="h-4 w-4" />
                    </Button>
                  </div>
                ...
                <div>
                  <div className="text-sm sm:text-base text-[#707070] font-medium mb-1">Total</div>
                  <div className="text-lg sm:text-xl text-[#111827] font-normal">${(product.price * quantity).toFixed(2)}</div>
                </div>
              </div>
              ...
              {activeTab === "details" && (
                <div className="p-4 sm:p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-4 text-base sm:text-lg">Product Specifications</h3>
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-4 text-base sm:text-lg">Farm Practices</h3>
                      <p className="text-gray-700 text-sm sm:text-base">Sustainable farming, No synthetic pesticides, Drip irrigation</p>
                    </div>
                  </div>
                </div>
              )}
                  ...
                  <div className="space-y-6">
                    <div>
                      <Dialog className="!bg-black" open={showReviewModal} onOpenChange={setShowReviewModal}>
                        ...
                        <DialogContent className="sm:max-w-md">
                          <DialogHeader>
                            <DialogTitle className="text-base sm:text-lg">Write Your Review</DialogTitle>
                          </DialogHeader>
                          <div className="space-y-6">
                            {/* Star Rating */}
                            <div>
                              <Label className="text-xs sm:text-sm font-medium text-gray-700 mb-3">Rate Us</Label>
                              <div className="flex gap-1 mt-2">
                                {[1, 2, 3, 4, 5].map((star) => (
                                  <button
                                    key={star}
                            ...
                            {/* Description */}
                            <div>
                              <Label htmlFor="review-description" className="text-xs sm:text-sm font-medium text-gray-700 mb-3">
                                Description
                              </Label>
                              <Textarea
                                id="review-description"
                    ...
                    <div>
                      {product.review.length === 0 ? (
                        <p className="text-gray-700 text-sm sm:text-base">No reviews yet. Be the first to write a review!</p>
                      ) : (
                        product.review.map((review, index) => (
                          <div key={index} className="mb-6">
                            <div className="flex items-center gap-4">
